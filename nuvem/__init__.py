...
regra nenhuma.
    ...
    login_dialogo.py  a janela de login, de criar conta e a de espera
    usuarios.py       quem trabalha aqui e o que cada um alcança
    usuarios_frame.py a tela do admin sobre isso
